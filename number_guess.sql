...
INSERT INTO public.record VALUES (88, 12, 1);
INSERT INTO public.record VALUES (88, 6, 2);
...
INSERT INTO public.usernames VALUES (88, 'AYOUB');
...
SELECT pg_catalog.setval('public.usernames_user_id_seq', 88, true);
...
--
-- Name: record record_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.record
    ADD CONSTRAINT record_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.usernames(user_id);
